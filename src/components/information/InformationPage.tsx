        ...
        if (type === "buddha") {
          ...
          const buddhaData = {
            ...
            8: {
              ...
              description:
                "พระพุทธรูปปางมารวิชัยสร้างขึ้นในสมัยพระบาทสมเด็จพระนั่งเกล้าเจ้าอยู่หัว รัชกาลที่ 3 ปี พ.ศ.2382 สร้างโดยการนำกลักสูบฝิ่นมาหลอมเป็นองค์พรเรียกกันว่าหลวงพ่อกลัดฝิ่นและในเวลาต่อมา พระบาทสมเด็จพระจอมเกล้าเจ้าอยู่หัว รัชกาลที่ 4 ทรงพระราชทานนามว่า 'พระพุทธเสรฏฐมุนี' ขึ้นชื่อในการขอขมากรรม",
              worshipGuide: {
                title: "ลำดับการไหว้",
                steps: [
                  "จุดธูปเทียน",
