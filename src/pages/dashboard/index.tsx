    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 pb-20">
        ...
        <div className="bg-[#FF7A05] text-white p-4 rounded-br-[140px]">
          ...
          >
            <div
              className="flex gap-4 min-w-max pt-2 pb-2"
              style={{
                overflow: "hidden",
              }}
            >
              <button
                className={`flex flex-col items-center justify-center rounded-full py-4 px-2 my-2 ml-2 w-[70px] transition-all duration-300
    ${
      activeCategory === "sacred"
        ? "bg-gradient-to-b from-yellow-100 to-orange-100 border-2 border-orange-300 shadow-[0_0_10px_2.5px_rgba(255,187,0,0.6)] transform -translate-y-0.5 scale-105"
        : "bg-white"
    }`}
              ...
              >
                  ...
                  >
                    <g clipPath="url(#clip0_2486_299)">
                      <path
                        ...
                        fill={
                          activeCategory === "sacred" ? "#FF7A05" : "#FFBB7E"
                        }
                      />
                      <path
                ...
                <p
                  className={`text-center text-xs font-bold z-30 ${
                    activeCategory === "sacred"
                      ? "text-[#FF7A05]"
                      : "text-[#FFBB7E]"
                  }`}
              ...
              <button
                className={`flex flex-col items-center justify-center rounded-full py-4 px-2 my-2 ml-1 w-[70px] transition-all duration-300
                  ${
                    activeCategory === "wish"
                      ? "bg-gradient-to-b from-yellow-100 to-orange-100 border-2 border-orange-300 shadow-[0_0_10px_2.5px_rgba(255,187,0,0.6)] transform -translate-y-0.5 scale-105"
                      : "bg-white"
              ...
              >
                  ...
                  >
                    <g clip-path="url(#clip0_2486_303)">
                      <path
                        ...
                        fill={activeCategory === "wish" ? "#FF7A05" : "#FFBB7E"}
                      />
                      <path
                ...
                <p
                  className={`text-center text-xs font-bold z-30 text-nowrap ${
                    activeCategory === "wish"
                      ? "text-[#FF7A05]"
                      : "text-[#FFBB7E]"
                  }`}
                  ...
                  >
                    <g clip-path="url(#clip0_2486_321)">
                      <path
                        ...
                        fill={
                          activeCategory === "ceremony" ? "#FF7A05" : "#FFBB7E"
                        }
                      />
                    </g>
                    <defs>
                  ...
                  >
                    <g clip-path="url(#clip0_2486_308)">
                      <path
                        ...
                        fill={
                          activeCategory === "activity" ? "#FF7A05" : "#FFBB7E"
                        }
                      />
                      <path
                      ...
                      <path
                        ...
                        fill={
                          activeCategory === "activity" ? "yellow-100" : "white"
                        }
                      />
                      <path
              ...
              {/* เพิ่มปุ่มซื้อตั๋ว */}
              <button
                className={`flex flex-col items-center justify-center rounded-full py-4 px-2 my-2 ml-1 mr-3 w-[70px] transition-all duration-300
                ${
                  ...
                  >
                    <g clip-path="url(#clip0_2754_1536)">
                      <path
                        ...
                        fill={
                          activeCategory === "ticket" ? "#FF7A05" : "#FFBB7E"
                        }
                      />
                      <path
