    ...
    <div className={`h-screen bg-orange-300 flex flex-col overflow-hidden`}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        ...
        <div className="w-full max-w-sm mb-8">
          <div className="flex justify-between items-center relative">
            {/* Connection Line - ขยายความหนาจาก h-0.5 เป็น h-1 */}
            <div className="absolute top-10 left-8 right-10 h-1 bg-gray-400"></div>
            ...
            {journey.points.map((point, index) => (
              ...
              >
                {/* ขยายขนาดหมุดจาก w-8 h-8 เป็น w-12 h-12 */}
                <div className="w-12 h-12 transition-all duration-300 flex items-center justify-center">
                  <img
                    src={getLocationImage(index, currentPoint)}
                    alt={`Location ${index + 1}`}
                    className="w-16 h-16 object-contain" /* ขยายขนาดรูปภาพจาก w-50 h-50 เป็น w-16 h-16 */
                  />
                </div>
                {/* ขยายขนาดตัวอักษรจาก text-xs เป็น text-sm และเพิ่ม margin top */}
      ...
      >
        <button
          ...
          className="bg-orange-500 text-white py-3 px-6 rounded-full font-semibold text-lg flex items-center justify-center shadow-lg hover:bg-orange-600 transition-colors mx-auto w-32"
        >
          <span className="mr-2">
            <svg
              width="20"
            ...
            >
              <g clipPath="url(#clip0_2775_1201)">
                <path
