...
const ARViewer = ({ statue, onClose }: { statue: BuddhaStatueDetail, onClose: () => void }) => {
        ...
        const startCamera = async () => {
            try {
                ...
                if (err instanceof Error && err.name === 'NotAllowedError') {
                    ...
                    setError('ไม่สามารถเริ่มกล้องได้: ' + (err instanceof Error ? err.message : 'Unknown error'));
                }
                setIsLoading(false);
            }
        };
        ...
        const statues: BuddhaStatueDetail[] = [
            {
                ...
                image: "https://storage.googleapis.com/noumi-3d-models/พระกริ่งใหญ่.glb",
                glbModel: "/images/glb/พระกริ่งใหญ่.glb", // ใช้ไฟล์ที่มี
                ...
                history: "พระพุทธศรีศากยมุนี พระประธานในพระวิหารหลวง วัดสุทัศนเทพวราราม เป็นพระหล่อด้วยโลหะ หน้าตักกว้าง 3 วา 1 คืบ ใหญ่กว่าพระพุทธรูปหล่อองค์อื่นเดิมที พระศรีศากยมุนี เป็นพระประธานอยู่ในพระวิหารหลวงวัดมหาธาตุเมืองสุโขทัย หล่อขึ้นในสมัยกรุงสุโขทัย แต่เมื่อได้เกิดการชำรุด พระบาทสมเด็จพระพุทธยอดฟ้าจุฬาโลกฯ จึงดำรัสสั่งให้เชิญย้ายลงมากรุงเทพฯ ประดิษฐานไว้กลางพระนคร",
                popular: true,
            ...
            },
            {
                ...
                glbModel: "https://storage.googleapis.com/noumi-3d-models/พระสุนทรีวารี.glb", // ใช้ไฟล์ที่มี
            ...
            },
            {
                ...
                glbModel: "https://storage.googleapis.com/noumi-3d-models/พระพุทธรังสีมุทราภัย.glb",
                ...
                openingHours: "08.00 - 20.00 น.",
                location: "ช่วงเวลา เปิด-ปิด",
                history: "พระบาทสมเด็จพระนั่งเกล้าเจ้าอยู่หัวทรงโปรดให้นำกลักฝิ่นที่เหลือจากการหล่อพระพุทธรูปมาซ่อมแปลงพระพุทธรูปองค์นี้ที่ชำรุดอยู่ ต่อมาพระบาทสมเด็จพระจอมเกล้าเจ้าอยู่หัวทรงโปรดให้อัญเชิญมาประดิษฐานที่ศาลาการเปรียญ วัดสุทัศนเทพวราราม",
                popular: false,
                views360Available: true,
            },{
                id: 4,
                ...
                glbModel: "https://storage.googleapis.com/noumi-3d-models/พระพุทธเสฏฐมุนี.glb",
                ...
                openingHours: "08.00 - 20.00 น.",
                location: "ช่วงเวลา เปิด-ปิด",
                history: "พระพุทธรูปปางมารวิชัยสร้างขึ้นในสมัยพระบาทสมเด็จพระนั่งเกล้าเจ้าอยู่หัว รัชกาลที่ 3 ปี พ.ศ.2382 สร้างโดยการนำกลักสูบฝิ่นมาหลอมเป็นองค์พร เรียกกันว่าหลวงพ่อกลัดฝิ่นและในเวลาต่อมา พระบาทสมเด็จพระจอมเกล้าเจ้าอยู่หัว รัชกาลที่ 4 ทรงพระราชทาน นามว่า 'พระพุทธเสรฏฐมุนี' ขึ้นชื่อในการขอขมากรรม",
                popular: false,
                views360Available: true,
            },
            {
                ...
                glbModel: "https://storage.googleapis.com/noumi-3d-models/พระพุทธตรีโลกเชษฐ์.glb",
                benefits: ["การเรียนการงาน"],
                description: "พระพุทธรูปประจำวิหารด้านทิศใต้",
                category: "พระพุทธรังสีมุทราภัย",
                subcategory: "การเรียน / การงาน",
                openingHours: "08.00 - 20.00 น.",
                location: "ช่วงเวลา เปิด-ปิด",
                history: "เป็นพระพุทธรูปสมัยรัตนโกสินทร์ พระบาทสมเด็จพระนั่งเกล้าเจ้าอยู่หัว รัชกาลที่ 3 ทรงโปรดให้สร้างขึ้นเป็นพระประธานประดิษฐาน ณ พระอุโบสถ และทรงโปรดอัญเชิญพระบรมสารีริกธาตุประดิษฐานไว้ภายในองค์พระผนังภายในเขียนภาพจิตรกรรมฝีมือช่างสมัยรัชกาลที่ 3 มีพระอสีติมหาสาวกจำนวน 80 องค์",
                popular: false,
                views360Available: true,
            },
            {
                ...
                glbModel: "https://storage.googleapis.com/noumi-3d-models/พระกริ่งใหญ่.glb",
            ...
            },
            {
                ...
                glbModel: "https://storage.googleapis.com/noumi-3d-models/ท้าวเวสสุวรรณ.glb",
                ...
                openingHours: "08.00 - 20.00 น.",
                location: "ช่วงเวลา เปิด-ปิด",
                history: "ท้าวเวสสุวรรณ เด่นเรื่อง บูชากราบไหว้ท้าวเวสสุวรรณจะมาขอพรเรื่องขอให้เจริญในหน้าที่การงาน ความเฮงความปัง รับทรัพย์ ขอโชคขอลาภ ป้องกันภยันตราย",
                popular: false,
                views360Available: true,
            },
             {
                ...
                templeName: "วัดสุทัศน์เทพวราราม",
                image: "/images/temple-list/ท้าวเวสุวรรณ.jpg",
                glbModel: "https://storage.googleapis.com/noumi-3d-models/พระรูปสมเด็จพระสังฆราช.glb",
                benefits: ["การเรียนการงาน"],
                description: "พระพุทธรูปประจำวิหารด้านทิศใต้",
                category: "พระพุทธรังสีมุทราภัย",
                subcategory: "การเรียน / การงาน",
                openingHours: "08.00 - 20.00 น.",
                location: "ช่วงเวลา เปิด-ปิด",
                history: "สมเด็จพระสังฆราช พระองค์ที่ 12 แห่งกรุงรัตนโกสินทร์ พ.ศ 2481-2487 อดีตเจ้าอาวาสวัดสุทัศนเทพวราราม พระองค์ที่ 4 ทรงได้รับการยกย่องเป็นพระคณาจารย์ที่โด่งดังในการสร้างพระกริ่งของเมืองไทย ส่งเริ่มสร้างมาตั้งแต่ปีพ.ศ 2441 ถึง 2486",
                popular: false,
                views360Available: true,
            },
        ];
        ...
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-center">
                    ...
                    <Link href="/sacred-places-moo" className="text-orange-500 mt-4 inline-block">
                        กลับไปหน้าหลัก
                    </Link>
                </div>
            </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center px-6">
                        <div className="text-center text-white z-10 w-full max-w-sm">
                            ...
                            >
                                ...
                                <div className="text-sm opacity-90">การให้จังหวัดทั่วการบัดใส "สวงและยอพร"</div>
                            </button>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-t-3xl -mt-8 relative z-10 p-6 min-h-96">
                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                            <h3 className="text-xl font-bold text-gray-800">{statue.name}</h3>
                        </div>
                        <div className="text-right">
                            <p className="text-gray-800 font-bold text-base">{statue.subcategory}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                            <p className="text-gray-800 font-medium text-base">{statue.location}</p>
                        </div>
                        <div className="text-right">
                            <p className="text-gray-800 font-bold text-base">{statue.openingHours}</p>
                        </div>
                    </div>
