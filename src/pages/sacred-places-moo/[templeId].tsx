...
const handleBuddhaStatueClick = (statueId: number) => {
  router.push(`/information-moo/${statueId}?type=buddha&templeId=${templeId}`);
};
              ...
              {filteredStatues.map((statue) => (
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    {/* ข้อมูล */}
                    <div className="ml-4">
                      <h3 className="text-[#FF8CB7] font-bold text-lg">
                        {statue.name}
                      </h3>
                      <p className="text-[#FF8CB7] text-sm">
                        {statue.templeName}
                      </p>
                  ...
                  <div className="flex flex-col items-end">
                    {statue.benefits.map((benefit, index) => (
                      <span
                        key={index}
                        className="bg-[#FFC800] text-[#FF8CB7] font-bold text-md px-2 py-2 w-24 rounded-xl text-center mt-11 cursor-pointer"
                      >
                        {benefit}
                      </span>
                    ))}
